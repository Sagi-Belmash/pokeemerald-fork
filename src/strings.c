...
ALIGNED(4) const u8 gText_PickNextCancel[] = _("{DPAD_UPDOWN}איסוף {A_BUTTON}הבא {B_BUTTON}ביטול");
ALIGNED(4) const u8 gText_PickCancel[] = _("{DPAD_UPDOWN}איסוף {A_BUTTON}{B_BUTTON}ביטול");
...
const u8 gText_ShopQuit[] = _("להפסיק");
...
const u8const u8 gText_NoMoreDecorations[] = _("לא ניתן לשים עוד קישוטים.\nהכי הרבה שניתן לשים זה {STR_VAR_1}.");
...
const u8 gText_TossItem[] = _("זריקת פריט");
 gText_StoreItemsInPC[] = _("הפקדת פריטים במחשב.");
