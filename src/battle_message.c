...
static const u8 sText_AvoidedDamage[] = _("{B_DEF_NAME_WITH_PREFIX} נמנע/ה\nמנזק בעזרת {B_DEF_ABILITY}!");
static const u8 sText_PkmnMakesGroundMiss[] = _("{B_DEF_NAME_WITH_PREFIX} גורם/ת למהלכי\nאדמה להחמיץ בעזרת {B_DEF_ABILITY}!");
static const u8 sText_PkmnAvoidedAttack[] = _("{B_DEF_NAME_WITH_PREFIX} נמנע/ה\nמההתקפה!");
...
static const u8 sText_PreventsEscape[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} מונע/ת\nבריחה בעזרת {B_SCR_ACTIVE_ABILITY}!\p");
static const u8 sText_CantEscape2[] = _("לא יכול לברוח!\p");
static const u8 sText_AttackerCantEscape[] = _("{B_ATK_NAME_WITH_PREFIX} לא יכול/ה לברוח!");
...
static const u8 sText_PkmnWasDefrostedBy[] = _("{B_ATK_NAME_WITH_PREFIX}\nהופשר/ה בעזרת {B_CURRENT_MOVE}!");
static const u8 sText_PkmnWasParalyzed[] = _("{B_EFF_NAME_WITH_PREFIX} משותק/ת!\nלא ניתן לזוז!");
static const u8 sText_PkmnWasParalyzedBy[] = _("ה{B_SCR_ACTIVE_ABILITY} של {B_SCR_ACTIVE_NAME_WITH_PREFIX}\nשיתק את {B_EFF_NAME_WITH_PREFIX}!\lייתכן שלא י/תוכל לזוז!");
static const u8 sText_PkmnIsParalyzed[] = _("{B_ATK_NAME_WITH_PREFIX} שותק/ה!\nלא ניתן לזוז!");
...
static const u8 sText_PkmnWasConfused[] = _("{B_EFF_NAME_WITH_PREFIX} נהייה\nמבולבל/ת!");
...
static const u8 sText_WildFled[] = _("{PLAY_SE SE_FLEE}{B_LINK_OPPONENT1_NAME} ברח{B_ADD_HEY}!");
static const u8 sText_TwoWildFled[] = _("{PLAY_SE SE_FLEE}{B_LINK_OPPONENT1_NAME}\nו{B_LINK_OPPONENT2_NAME} ברחו!");
...
static const u8 sText_Trainer1Fled[] = _( "{PLAY_SE SE_FLEE}{B_TRAINER1_CLASS} {B_TRAINER1_NAME} ברח{B_ADD_HEY}!");
