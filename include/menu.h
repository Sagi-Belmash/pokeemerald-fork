...
void AddTextPrinterParameterized3WithRTL(u8 windowId, u8 fontId, s8 left, u8 top, const u8 *color, s8 speed, const u8 *str, bool8 rtlMode);
...
void AddTextPrinterParameterized4WithRTL(u8 windowId, u8 fontId, s8 left, u8 top, u8 letterSpacing, u8 lineSpacing, const u8 *color, s8 speed, const u8 *str, bool8 rtlMode);
...
void AddTextPrinterParameterized5WithRTL(u8 windowId, u8 fontId, const u8 *str, s8 left, u8 top, u8 speed, void (*callback)(struct TextPrinterTemplate *, u16), u8 letterSpacing, u8 lineSpacing, bool8 rtlMode);
