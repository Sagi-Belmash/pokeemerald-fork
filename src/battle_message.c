...
static const u8 sText_GotAwaySafely[] = _("{PLAY_SE SE_FLEE}מילוט בשלום!\p");
...
static const u8 sText_DontLeaveBirch[] = _("פרופ. בירץ': אל תשאיר אותי ככה!\p"); // Female Support Needed
