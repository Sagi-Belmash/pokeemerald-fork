...
const u8 gText_ContinueMenuPlayer[] = _("שחק{CHAR_SWAP 0xED}{ADD_YUD}{ADD_TAF}"); //ן
...
const u8 gText_SavingPlayer[] = _("שחק{CHAR_SWAP 0xED}{ADD_YUD}{ADD_TAF}");
