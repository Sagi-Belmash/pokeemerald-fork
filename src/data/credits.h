...
static const u8 sCreditsText_PkmnEmeraldVersion[]             = _("פוקימון גרסת ברקת");
static const u8 sCreditsText_Credits[]                        = _("קרדיט");
static const u8 sCreditsText_ExecutiveDirector[]              = _("מנהל בכיר");
static const u8 sCreditsText_Director[]                       = _("מנהל");
static const u8 sCreditsText_ArtDirector[]                    = _("מנהל אומנותי");
static const u8 sCreditsText_BattleDirector[]                 = _("מנהל קרב");
static const u8 sCreditsText_MainProgrammer[]                 = _("מתכנת ראשי");
static const u8 sCreditsText_BattleSystemPgrms[]              = _("מתכנתי מערכת הקרב");
static const u8 sCreditsText_FieldSystemPgrms[]               = _("מתכנת מערכת השטח");
static const u8 sCreditsText_Programmers[]                    = _("מתכנתים");
static const u8 sCreditsText_MainGraphicDesigner[]            = _("מעצב גרפי ראשי");
static const u8 sCreditsText_GraphicDesigners[]               = _("מעצבים גרפיים");
static const u8 sCreditsText_PkmnDesigners[]                  = _("מעצבי פוקימון");
static const u8 sCreditsText_MusicComposition[]               = _("הלחנת מוזיקה");
static const u8 sCreditsText_SoundEffectsAndPkmnVoices[]      = _("אפקטים קוליים וקולות פוקימון");
static const u8 sCreditsText_GameDesigners[]                  = _("מעצבי משחק");
static const u8 sCreditsText_ScenarioPlot[]                   = _("עלילת תסריט");
static const u8 sCreditsText_Scenario[]                       = _("תסריט");
static const u8 sCreditsText_ScriptDesigners[]                = _("מעצבי תסריט");
static const u8 sCreditsText_MapDesigners[]                   = _("מעצבי מפות");
static const u8 sCreditsText_MapDataDesigners[]               = _("מעצבי נתוני מפות");
static const u8 sCreditsText_ParametricDesigners[]            = _("מעצבי פרמטרים");
static const u8 sCreditsText_PokedexText[]                    = _("טקסט הפוקידע");
static const u8 sCreditsText_EnvAndToolPgrms[]                = _("מתכנתי סביבה וכלי פיתוח");
static const u8 sCreditsText_NCLProductTesting[]              = _("LCN בדיקות מוצר");
static const u8 sCreditsText_SpecialThanks[]                  = _("תודות מיוחדות");
static const u8 sCreditsText_Coordinators[]                   = _("מתאמים");
static const u8 sCreditsText_Producers[]                      = _("מפיקים");
static const u8 sCreditsText_ExecProducers[]                  = _("מפיקים בכירים");
static const u8 sCreditsText_InfoSupervisors[]                = _("מפקחי מידע");
static const u8 sCreditsText_TaskManagers[]                   = _("מנהלי משימות");
static const u8 sCreditsText_BrailleCodeCheck[]               = _("בדיקת קוד ברייל");
static const u8 sCreditsText_WorldDirector[]                  = _("מנהל עולם המשחק");
static const u8 sCreditsText_BattleFrontierData[]             = _("נתוני חזית הקרב");
static const u8 sCreditsText_SupportProgrammers[]             = _("מתכנתי תמיכה");
...
static const u8 sCreditsText_JunichiMasuda[]                  = _("adusaM ihcinuJ");
...
static const u8 sCreditsText_YoshinoriMatsuda[]               = _("adustaM ironihsoY");
...
static const u8 sCreditsText_HironobuYoshida[]                = _("adihsoY ubonoriH");
...
static const u8 sCreditsText_AtsukoNishida[]                  = _("adihsiN okustA");
...
static const u8 sCreditsText_KenjiMatsushima[]                = _("amihsustaM ijneK");
...
static const u8 sCreditsText_KenjiTominaga[]                  = _("aganimoT ijneK");
...
static const u8 sCreditsText_NaokoYanase[]                    = _("esanaY okoaN");
static const u8 sCreditsText_NCLSuperMarioClub[]              = _("bulC oiraM repuS LCN");
static const u8 sCreditsText_AtsushiTada[]                    = _("adaT ihsustA");
...
static const u8 sCreditsText_MichikoTakizawa[]                = _("awazikaT okihciM");
static const u8 sCreditsText_MakikoTakada[]                   = _("adakaT okikaM");
static const u8 sCreditsText_TakanaoKondo[]                   = _("odnoK oanakaT");
...
static const u8 sCreditsText_HiroakiTsuru[]                   = _("urusT ikaoriH");
static const u8 sCreditsText_TsunekazIshihara[]               = _("arahihsI zakenusT");
static const u8 sCreditsText_SatoruIwata[]                    = _("atawI urotaS");
...
static const u8 sCreditsText_MikikoOhhashi[]                  = _("ihsahhO okikiM");
...
static const u8 sCreditsText_SethMcMahill[]                   = _("llihaMcM hteS");
...
static const u8 sCreditsText_NationalFederationBlind[]        = _("dnilB eht fo noitaredeF lanoitaN");
...
static const u8 sCreditsText_RoyalNewZealandFederationBlind[] = _("dnilB eht rof noitaredeF dnalaeZ weN layoR");
static const u8 sCreditsText_MotoyasuTojima[]                 = _("amijoT usayotoM");
static const u8 sCreditsText_NicolaPrattBarlow[]              = _("wolraB-ttarP alociN");
