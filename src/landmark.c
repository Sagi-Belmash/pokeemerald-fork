...
static const u8 LandmarkName_FlowerShop[] = _("חנות פרחים");
static const u8 LandmarkName_PetalburgWoods[] = _("יערות פטלבורג");
static const u8 LandmarkName_MrBrineysCottage[] = _("בקתת מר ברייני");
static const u8 LandmarkName_AbandonedShip[] = _("הספינה הנטושה");
static const u8 LandmarkName_SeashoreHouse[] = _("בית חוף הים");
static const u8 LandmarkName_SlateportBeach[] = _("חוף סלייטפורט");
static const u8 LandmarkName_CyclingRoad[] = _("שביל האופניים");
static const u8 LandmarkName_NewMauville[] = _("מוויל החדשה");
static const u8 LandmarkName_TrickHouse[] = _("בית הטריקים");
static const u8 LandmarkName_OldLadysRestShop[] = _("בית מנוחה של הגברת הזקנה");
static const u8 LandmarkName_Desert[] = _("מדבר");
static const u8 LandmarkName_WinstrateFamily[] = _("משפחת וינסטרייט");
static const u8 LandmarkName_CableCar[] = _("רכבל");
static const u8 LandmarkName_GlassWorkshop[] = _("סדנת זכוכית");
static const u8 LandmarkName_WeatherInstitute[] = _("מכון מזג האוויר");
static const u8 LandmarkName_MeteorFalls[] = _("מפלי מטאור");
static const u8 LandmarkName_TunnelersRestHouse[] = _("בית מנוחת החופרים");
static const u8 LandmarkName_RusturfTunnel[] = _("מנהרת רסטרף");
static const u8 LandmarkName_PokemonDayCare[] = _("מעון פוקימון");
static const u8 LandmarkName_SafariZoneEntrance[] = _("כניסה לאזור הספארי");
static const u8 LandmarkName_MtPyre[] = _("הר המוקד");
static const u8 LandmarkName_ShoalCave[] = _("מערת השרטון");
static const u8 LandmarkName_SeafloorCavern[] = _("מחילת קרקעית הים");
static const u8 LandmarkName_GraniteCave[] = _("מערת הגרניט");
static const u8 LandmarkName_OceanCurrent[] = _("זרם אוקיינוס");
static const u8 LandmarkName_LanettesHouse[] = _("הבית של לאנט");
static const u8 LandmarkName_FieryPath[] = _("מעבר לוהט");
static const u8 LandmarkName_JaggedPass[] = _("מעבר משונן");
static const u8 LandmarkName_SkyPillar[] = _("עמוד השמיים");
static const u8 LandmarkName_BerryMastersHouse[] = _("בית המאסטר פירות יער");
static const u8 LandmarkName_IslandCave[] = _("מערת אי");
static const u8 LandmarkName_DesertRuins[] = _("חורבות מדבר");
static const u8 LandmarkName_ScorchedSlab[] = _("לוח חרוך");
static const u8 LandmarkName_AncientTomb[] = _("קבר עתיק");
static const u8 LandmarkName_SealedChamber[] = _("תא אטום");
static const u8 LandmarkName_FossilManiacsHouse[] = _("הבית של מטורף המאובנים");
static const u8 LandmarkName_HuntersHouse[] = _("בית הצייד");
static const u8 LandmarkName_MagmaHideout[] = _("מחבוא מגמה");
static const u8 LandmarkName_MirageTower[] = _("מגדל התעתוע");
static const u8 LandmarkName_AlteringCave[] = _("מערת השינוי");
static const u8 LandmarkName_DesertUnderpass[] = _("מעבר תת-קרקע מדברי");
static const u8 LandmarkName_TrainerHill[] = _("גבעת המאמן");
