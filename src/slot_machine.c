...
static bool8 SlotTask_PrintMsg_Need3Coins(struct Task *task)
{
    ...
    AddTextPrinterParameterizedWithRTL(0, FONT_NORMAL, gText_YouDontHaveThreeCoins, 0, 1, 0, 0, TRUE);
...
{
    DrawDialogueFrame(0, FALSE);
    AddTextPrinterParameterizedWithRTL(0, FONT_NORMAL, gText_QuitTheGame, 0, 1, 0, 0, TRUE);
    CopyWindowToVram(0, COPYWIN_FULL);
...
{
    DrawDialogueFrame(0, FALSE);
    AddTextPrinterParameterizedWithRTL(0, FONT_NORMAL, gText_YouveGot9999Coins, 0, 1, 0, 0, TRUE);
    CopyWindowToVram(0, COPYWIN_FULL);
...
{
    DrawDialogueFrame(0, FALSE);
    AddTextPrinterParameterizedWithRTL(0, FONT_NORMAL, gText_YouveRunOutOfCoins, 0, 1, 0, 0, TRUE);
    CopyWindowToVram(0, COPYWIN_FULL);
...
{
    AddTextPrinterParameterized3WithRTL(1, FONT_NORMAL, 2, 5, sColors_ReeltimeHelp, 0, gText_ReelTimeHelp, TRUE);
