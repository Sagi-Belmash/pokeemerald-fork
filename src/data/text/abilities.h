...
static const u8 sSturdyDescription[] = _("מבטל מתקפות מיגור.");
...
static const u8 sMagnetPullDescription[] = _("לוכד פוקימוני מתכת.");
...
{
    [ABILITY_NONE] = _("-------"),
    [ABILITY_STENCH] = _("סירחון"),
    [ABILITY_DRIZZLE] = _("זרזיף"),
    ...
    [ABILITY_VOLT_ABSORB] = _("קולט חשמל"),
    [ABILITY_WATER_ABSORB] = _("סופג מים"),
    ...
    [ABILITY_LIGHTNING_ROD] = _("מוט ברק"),
    ...
    [ABILITY_LIQUID_OOZE] = _("ניקוז קטלני"),
    [ABILITY_OVERGROW] = _("גידול יתר"),
