...
const u8 gText_DefaultNameLucy[] = _("אלה");
...
const u8 gText_LevelSymbol[] = _("רמה");
...
const u8 gText_LvVar1[] = _("רמה{STR_VAR_1}");
...
const u8 gText_PokemonMaleLv[] = _("{DYNAMIC 0}{COLOR_HIGHLIGHT_SHADOW LIGHT_RED WHITE GREEN}♂{COLOR_HIGHLIGHT_SHADOW DARK_GRAY WHITE LIGHT_GRAY}/רמה{DYNAMIC 1}"); // Unused
const u8 gText_PokemonFemaleLv[] = _("{DYNAMIC 0}{COLOR_HIGHLIGHT_SHADOW LIGHT_GREEN WHITE BLUE}♀{COLOR_HIGHLIGHT_SHADOW DARK_GRAY WHITE LIGHT_GRAY}/רמה{DYNAMIC 1}"); // Unused
const u8 gText_PokemonNoGenderLv[] = _("{DYNAMIC 0}/רמה{DYNAMIC 1}"); // Unused
...
const u8 gText_PokemonMaleLv2[] = _("{DYNAMIC 0}{COLOR_HIGHLIGHT_SHADOW LIGHT_RED WHITE GREEN}♂{COLOR_HIGHLIGHT_SHADOW DARK_GRAY WHITE LIGHT_GRAY}/רמה{DYNAMIC 1}{DYNAMIC 2}"); // Unused
const u8 gText_PokemonFemaleLv2[] = _("{DYNAMIC 0}{COLOR_HIGHLIGHT_SHADOW LIGHT_GREEN WHITE BLUE}♀{COLOR_HIGHLIGHT_SHADOW DARK_GRAY WHITE LIGHT_GRAY}/רמה{DYNAMIC 1}{DYNAMIC 2}"); // Unused
const u8 gText_PokemonNoGenderLv2[] = _("{DYNAMIC 0}/רמה{DYNAMIC 1}{DYNAMIC 2}"); // Unused
...
const u8 gText_TrainerCardIDNo[] = _("מס' מזהה         "); //IDNo.
...
const u8 gText_ContinueMenuPlayer[] = _("שם"); //Player is gender neutral while שחקן is not
...
const u8 gText_PkmnsNickname[] = _("שם חיבה ל{STR_VAR_1}?");
...
const u8 gText_SavingPlayer[] = _("שם"); //Player is gender neutral while שחקן is not
