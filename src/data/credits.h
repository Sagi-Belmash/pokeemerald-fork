...
static const u8 sCreditsText_NationalFederationBlind[]        = _("הפדרציה הלאומית לעיוורים");
...
static const u8 sCreditsText_RoyalNewZealandFederationBlind[] = _("פדרציה מלכותית בניו זילנד לעיוורים");
