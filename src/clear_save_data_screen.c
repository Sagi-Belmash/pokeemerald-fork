...
static void Task_DoClearSaveDataScreenYesNo(u8 taskId)
{
    ...
    AddTextPrinterParameterizedWithRTL(0, FONT_NORMAL, gText_ClearAllSaveData, 0, 1, 0, 0, TRUE);
...
static void Task_ClearSaveDataScreenYesNoChoice(u8 taskId)
{
    ...
    case 0:
        ...
        AddTextPrinterParameterizedWithRTL(0, FONT_NORMAL, gText_ClearingData, 0, 1, 0, 0, TRUE);
