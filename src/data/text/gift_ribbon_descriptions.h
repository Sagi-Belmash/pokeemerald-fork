const u8 gGiftRibbonDescriptionPart1_2003RegionalTourney[] = _("תחרות אזורית 3002");
const u8 gGiftRibbonDescriptionPart2_Champion[] = _("סרט אלוף");
const u8 gGiftRibbonDescriptionPart1_2003NationalTourney[] = _("תחרות לאומית 3002");
const u8 gGiftRibbonDescriptionPart1_2003GlobalCup[] = _("גביע עולמי 3002");
const u8 gGiftRibbonDescriptionPart2_RunnerUp[] = _("סרט סגן אלוף");
const u8 gGiftRibbonDescriptionPart2_Semifinalist[] = _("סרט חצי-גמר");
const u8 gGiftRibbonDescriptionPart1_2004RegionalTourney[] = _("תחרות אזורית 4002");
const u8 gGiftRibbonDescriptionPart1_2004NationalTourney[] = _("תחרות לאומית 4002");
const u8 gGiftRibbonDescriptionPart1_2004GlobalCup[] = _("גביע עולמי 4002");
const u8 gGiftRibbonDescriptionPart1_2005RegionalTourney[] = _("תחרות אזורית 5002");
const u8 gGiftRibbonDescriptionPart1_2005NationalTourney[] = _("תחרות לאומית 5002");
const u8 gGiftRibbonDescriptionPart1_2005GlobalCup[] = _("גביע עולמי 5002");
const u8 gGiftRibbonDescriptionPart1_PokemonBattleCup[] = _("גביע הקרב של פוקימון");
const u8 gGiftRibbonDescriptionPart2_Participation[] = _("סרט השתתפות");
const u8 gGiftRibbonDescriptionPart1_PokemonLeague[] = _("ליגת הפוקימון");
const u8 gGiftRibbonDescriptionPart1_AdvanceCup[] = _("גביע מתקדם");
const u8 gGiftRibbonDescriptionPart1_PokemonTournament[] = _("טורניר פוקימון");
const u8 gGiftRibbonDescriptionPart2_Participation2[] = _("סרט השתתפות");
const u8 gGiftRibbonDescriptionPart1_PokemonEvent[] = _("אירוע פוקימון");
const u8 gGiftRibbonDescriptionPart1_PokemonFestival[] = _("פסטיבל פוקימון");
const u8 gGiftRibbonDescriptionPart1_DifficultyClearing[] = _("סיום רמת קושי");
const u8 gGiftRibbonDescriptionPart2_Commemorative[] = _("סרט הוקרה");
const u8 gGiftRibbonDescriptionPart1_ClearingAllChallenges[] = _("סרט מוענק על");
const u8 gGiftRibbonDescriptionPart2_ClearingAllChallenges[] = _("השלמת כל האתגרים.");
const u8 gGiftRibbonDescriptionPart1_100StraightWin[] = _("001 ניצחונות רצופים");
const u8 gGiftRibbonDescriptionPart1_DarknessTower[] = _("מגדל האפלה - הושלם");
const u8 gGiftRibbonDescriptionPart1_RedTower[] = _("מגדל האדום - הושלם");
const u8 gGiftRibbonDescriptionPart1_BlackironTower[] = _("מגדל הברזל השחור - הושלם");
const u8 gGiftRibbonDescriptionPart1_FinalTower[] = _("המגדל הסופי - הושלם");
const u8 gGiftRibbonDescriptionPart1_LegendMaking[] = _("יוצר אגדות");
const u8 gGiftRibbonDescriptionPart1_PokemonCenterTokyo[] = _("מרכז פוקימון טוקיו");
const u8 gGiftRibbonDescriptionPart1_PokemonCenterOsaka[] = _("מרכז פוקימון אוסקה");
const u8 gGiftRibbonDescriptionPart1_PokemonCenterNagoya[] = _("מרכז פוקימון נאגויה");
const u8 gGiftRibbonDescriptionPart1_PokemonCenterNY[] = _("מרכז פוקימון ניו יורק");
const u8 gGiftRibbonDescriptionPart1_SummerHolidays[] = _("סרט חופשת קיץ");
const u8 gGiftRibbonDescriptionPart2_EmptyString[] = _("");
const u8 gGiftRibbonDescriptionPart1_WinterHolidays[] = _("סרט חופשת חורף");
const u8 gGiftRibbonDescriptionPart1_SpringHolidays[] = _("סרט חופשת אביב");
const u8 gGiftRibbonDescriptionPart1_Evergreen[] = _("סרט ירוק לעד");
const u8 gGiftRibbonDescriptionPart1_SpecialHoliday[] = _("סרט חג מיוחד");
const u8 gGiftRibbonDescriptionPart1_HardWorker[] = _("סרט עובד חרוץ");
const u8 gGiftRibbonDescriptionPart1_LotsOfFriends[] = _("סרט מלא חברים");
const u8 gGiftRibbonDescriptionPart1_FullOfEnergy[] = _("סרט מלא אנרגיה");
const u8 gGiftRibbonDescriptionPart1_LovedPokemon[] = _("סרט הוקרה לפוקימון אהוב");
const u8 gGiftRibbonDescriptionPart2_LovedPokemon[] = _("על היותו אהוב במיוחד.");
const u8 gGiftRibbonDescriptionPart1_LoveForPokemon[] = _("סרט המבטא");
const u8 gGiftRibbonDescriptionPart2_LoveForPokemon[] = _("אהבה לפוקימונים.");
